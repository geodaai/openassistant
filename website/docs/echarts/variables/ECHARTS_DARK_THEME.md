# Variable: ECHARTS\_DARK\_THEME

> `const` **ECHARTS\_DARK\_THEME**: `object`

Defined in: [echarts-theme.ts:1](https://github.com/GeoDaCenter/openassistant/blob/1a6f158a9bc0914d446c35a467a546a572748a5e/packages/echarts/src/echarts-theme.ts#L1)

## Type declaration

### backgroundColor

> **backgroundColor**: `string` = `'rgba(14,14,14,1)'`
...
#### categoryAxis.axisTick.lineStyle
...
> **dataBackgroundColor**: `string` = `'rgba(255,255,255,0.3)'`
...
#### timeAxis.splitArea.areaStyle.color
